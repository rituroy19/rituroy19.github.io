//load data for graph
data = d3.csv("https://raw.githubusercontent.com/rituroy19/rituroy19.github.io/master/PUI%20Final/Assets/data/PassengerDataAnnual.csv")

d3.group(data, d => d.name)

data.filter(d => d.name === "Atlanta")
