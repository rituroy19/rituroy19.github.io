//load data in the js file itself
...
//assigning the selection tool to make selections with pointers
		const Selection = vl.selectSingle()
    		.encodings('y');

//draws the left graph with various specifications. Selection highlight is made avaliable.
...
//draws the right graph with various specification. Selection highlight is made avaliable.
...
//embedded in html
      	...
      	.catch(console.warn); //Embed graph in visual3 div